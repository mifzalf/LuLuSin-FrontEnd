          ...
          >
            ...
            >
              <div className="flex items-center justify-center mb-1">
                ...
                <span className="font-semibold">Aqil Yogi Pramanto</span>
              </div>
              <div className="text-sm text-blue-200">006527262899</div>
            </motion.div>
            ...
            >
              <div className="flex items-center justify-center mb-1">
                ...
                <span className="font-semibold">Tes Potensi Skolastik</span>
              </div>
              <div className="text-sm text-blue-200">Literasi dalam bahasa indonesia tahun 2025</div>
            </motion.div>
